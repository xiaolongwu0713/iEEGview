...
if SegmentationFlag
    ...
    finishflag = 1; % 0/1; 1: finished in workstation
    while ~finishflag
        tmpfile = [getenv("FREESURFER_HOME") 'subjects/' ConfigurationPath.subject_name '/scripts/recon-all.log'];
        newfile = [getenv("FREESURFER_HOME") 'subjects/' ConfigurationPath.subject_name '/scripts/tmplog.log'];
    ...
    segfilefreesurfer=[getenv("FREESURFER_HOME"),'/subjects/',ConfigurationPath.subject_name];
